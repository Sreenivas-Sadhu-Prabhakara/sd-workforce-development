package com.bank.bian.workforcedevelopment.model;
...
/**
 * The BIAN control record for this service domain: "Workforce Plan Development Project".
 *
 * In BIAN, every Service Domain manages exactly one control record type whose
 * shape follows the domain's functional pattern (Develop) applied
 * to its asset type (Workforce Plan). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Workforce Plan Development Project";
