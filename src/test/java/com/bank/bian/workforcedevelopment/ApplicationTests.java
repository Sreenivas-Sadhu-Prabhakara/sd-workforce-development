...
class ApplicationTests {
    ...
    void serviceDomainMetadataIsServed() {
        ...
        assertThat(meta).containsEntry("serviceDomain", "Workforce Development");
        assertThat(meta).containsEntry("functionalPattern", "Develop");
    }

    @Test
    void controlRecordLifecycleWorks() {
        var created = rest.postForEntity(
                "http://localhost:" + port + "/v1/workforce-plan-development-project/initiate",
